...
Points can have cameras attached to them - see the [`addCamera`](/dsl/points/#addcamera) method in the Points documentation for details on how to attach cameras to points.
